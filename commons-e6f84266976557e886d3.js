...
function portfolio_inheritsLoose(subClass,superClass){subClass.prototype=Object.create(superClass.prototype);subClass.prototype.constructor=subClass;subClass.__proto__=superClass;}//import Filterizr from 'filterizr'
var portfolio_Portfolio=/*#__PURE__*/function(_Component){portfolio_inheritsLoose(Portfolio,_Component);function Portfolio(){return _Component.apply(this,arguments)||this;}var _proto=Portfolio.prototype;_proto.componentDidMount=function componentDidMount(){var _this=this;__webpack_require__.e(/* import() */ 7).then(__webpack_require__.t.bind(null, "+9LW", 7)).then(function(filterizr){_this.filterizr=filterizr;}).catch(function(error){return console.error(error);});var options={/* check next step for available options */};var filterizr=new Filterizr('.filter-container',options);};_proto.componentDidUpdate=function componentDidUpdate(){// Notify shuffle to dump the elements it's currently holding and consider
...
//# sourceMappingURL=commons-e6f84266976557e886d3.js.map